package org.example.ex9_palidrom;
/*
Check Palindromic Strings
Write a program that receives a list of strings from the user.
Implement a method to check and display whether each string in
the list is a palindrome (reads the same forwards and backwards) using streams.
